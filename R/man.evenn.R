...
function()
{
  ...
  write("#####################", file="")
  write("- Prototype:\n\t(annot=FALSE, path_res=\"\", path_lists=\"\", res=\"\", ud=FALSE, prop=FALSE, noms=\"\", overlaps=FALSE, f=0, Tk=FALSE, aa=FALSE)", file="")
  write("\n- Text tabulated files must be placed alone in a folder.\n", file="")
  write("\n- Linux users must use the put the folder path in \"path_lists\".\n", file="")
  write("\n- Default option produce a classical Venn diagram:\n\tevenn()\n", file="")
