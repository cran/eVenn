...
function()
{
  ...
  write("#####################", file="")
  write("- Prototype:\n\t(annot=FALSE, matLists=\"\", path_res=\"\", path_lists=\"\", res=\"\", ud=FALSE, prop=FALSE, noms=\"\", overlaps=FALSE, f=0, display=FALSE, FilesOut=TRUE, CompName=\"\")", file="")
  write("- Text tabulated files must be placed alone in a folder.", file="")
  write("- Linux users must use the put the folder path in \"path_lists\".", file="")
  write("- Default option produce a classical Venn diagram:\n\tevenn()", file="")
  ...
  write("- matLists [List of matrix]:\tTo use eVenn on matrix. The \"noms\" variable must be used to give names to the compared matrix / lists.", file="")
  ...
  write("- prop [TRUE/FALSE]:\tIf the surfaces of the disks should be proportional to the size of the lists.", file="")
  ...
  write("- display [TRUE/FALSE]:\tDraw a title in ascii art.", file="")
  write("- FilesOut [TRUE/FALSE]:\tFor use of eVenn without producing files but only return a results binary matrix. (results = evenn())t.", file="")
  write("- CompName [char]:\tName of the folder results.", file="")
}
